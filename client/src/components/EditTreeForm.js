...
const EditTreeForm = (props) => {
    ...
    <form onSubmit={props.onSubmit}>
      ...
      <Grid item xs={12} className="text-center">
          <Typography variant="display1">Edit Tree</Typography>
        </Grid>
        ...
        <Grid item xs={12} sm={12} className="text-center">
          <Button disabled={props.submitDisabled} className={classes.submitButton} fullWidth variant="raised" color="secondary" type="submit">Submit</Button>
        </Grid>
      </Grid>
    </form>
    )
  ...
  export default withStyles(styles)(EditTreeForm);